    ...
    <div style="max-width: 1200px; margin: 0 auto; padding: 0 40px;">
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 40px; margin-bottom: 40px;">
            ...
            <div style="display: flex; flex-direction: column; gap: 25px;">
                <div>
                    <h4 style="font-size: 18px; margin-bottom: 12px; font-weight: 700;">Jam Layanan</h4>
                    <p style="margin-bottom: 5px; opacity: 0.9; line-height: 1.6;">
            ...
            <div>
                <h4 style="font-size: 18px; margin-bottom: 12px; font-weight: 700;">Alamat Sekolah</h4>
            ...
            <div>
                <h4 style="font-size: 18px; margin-bottom: 12px; font-weight: 700;">Media Sosial Kami</h4>
                <div style="display: flex; gap: 12px; flex-wrap: wrap;">
                    ...
                    <a href="https://wa.me/6285349310534" target="_blank" style="width: 40px; height: 40px; background: rgba(255,255,255,0.2); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; text-decoration: none; transition: all 0.3s;">
