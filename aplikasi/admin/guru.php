...
<div class="card">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
        ...
        <button onclick="alert('Fitur tambah guru akan segera hadir!')" style="padding: 8px 16px; background: #0284c7; color: white; border: none; border-radius: 8px; cursor: pointer;">
            + Tambah Guru
        </button>
    </div>
    <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
        ...
        <tbody>
            <tr>
                <td colspan="4" style="padding: 20px; text-align: center; color: #94a3b8;">Belum ada data guru</td>
            </tr>
        </tbody>
    </table>
</div>
